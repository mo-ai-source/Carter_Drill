...
<body>
    ...
    <main>
        ...
        <div class="maininfo">
            ...
            <h1>Handles 2: Introduction</h1>

            <p>
              The first fundamental aspect of handling the ball is hand placement. Correct hand placement will give you better control over the ball and help you execute different moves with ease.
            </p>
            <p>
               When dribbling the ball, it's important to keep your fingertips on the ball and not your palm. This allows for better ball control and helps to reduce turnovers. Your fingers should be spread apart, with your pinky and ring fingers slightly lower on the ball than your index and middle fingers.
            <p>
               Additionally, your hand should be cupped around the ball, creating a pocket. This pocket will help you to cradle the ball and protect it from defenders. As you move around the court, try to keep your hand and arm relaxed, so that you can quickly and easily change direction or speed when needed.
