...
if (isset($_POST['conbtn'])) {
    ...
    if ($run) {
        header('Refresh: 0; URL=firstshooting3.php?id=' . $id);
    }
}
...
<body>
    ...
    <main>
        ...
        <div class="maininfo">
            ...
            <h1>Shooting 1 : Introduction</h1>

            <p>
                Welcome to the basketball shooting 1 course! This course is designed to help basketball players of all
                levels improve their shooting form and accuracy.
                Through a combination of theory and practice, you'll learn the proper techniques for shooting a
                basketball, as well as drills and exercises to help you refine your form and develop your skills.
            </p>
            ...
            <ul class="bullet">
                <li>Proper footwork for shooting a basketball </li>
                <li>Hand positioning and grip </li>
                <li> Follow-through and release techniques</li>
                <li> How to shoot with proper form and technique </li>
