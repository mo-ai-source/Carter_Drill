...
if(isset($_POST['conbtn'])){
  ...
  $fetch=mysqli_fetch_array($rungetprogress);
   ...
   if($run){
    header('Refresh: 0; URL=test7.php?id='.$id);
   }
}
...
<body>
    ...
    <main>
        ...
        <div class="maininfo">
            ...
            <h1>Strength 2 : Workout</h1>

            <img src="img/workouts/strength2.jpg" alt="Image description">
            <div style="text-align:center;">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/ykJmrZ5v0Oo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            <p></p>
             <p>
               <b>Loads:</b> Perform one or two warm-up sets of roughly three reps, without the slow eccentric, in order to find the right weight. For your work sets, choose a weight that will bring you near failure after five reps.


             </p>
             <p>
                    If the bicep curls are too easy, add some weight.
                    Things should get easier as you go. But they shouldn’t remain easy.
             </p>
