...
<body>
    ...
    <main>
        ...
        <div class="maininfo">
            ...
            <h1>Handles 1: Skills</h1>

             <p>
                As a fun activity, we have integrated YOLO (You Only Look Once), an object detection algorithm, into our website to allow users to detect basketballs in images and videos.

            </p>
            <p>
                To participate in this activity, you will need to upload an image or video that contains a basketball. The YOLO algorithm will analyze the image or video and identify the basketball.
            </p>
            <p>
                You can then use the information provided by YOLO to improve your basketball handling skills by analyzing the position of the basketball and developing strategies to handle the ball effectively.

            </p>

              <iframe src="http://localhost:5000" width="100%" height="600" frameborder="0"></iframe>
